...
data_path = '/mnt/fsx/data1//cell-analysis-processed/'
train_dir = datapath + 'train/'
eval_dir = datapath + 'test/'
...
parser.add_argument('--channels', type=int, default=3, metavar='N',
                    help='Number of channels in the image (default: 3 => model default)')
...
def main():
    ...
    dataset_train = trainset = CustomDataset(
        root_dir=train_dir, dim=args.img_size, channels=args.channels, TotalSamples=10000)
    ...
    dataset_eval = CustomDataset(
        root_dir=test_dir, dim=args.img_size, channels=args.channels, TotalSamples=1000)
