...
parser.add_argument('--channels', type=int, default=3, metavar='N',
                    help='Number of channels in Image(default: 3 => model default)')
...
if args.dataset=='cifar10':
    ...
    testset = torchvision.datasets.CIFAR100(
        root='./data', train=False, download=True, transform=transform_test)
elif args.dataset=='cell-phenotyping':
    args.num_classes = 8
    trainset = CustomDataset(root_dir=train_dir, dim=args.img_size, channels=args.channels, TotalSamples=10000)
else:
    print('Please provide an appropriate dataset configuration')
